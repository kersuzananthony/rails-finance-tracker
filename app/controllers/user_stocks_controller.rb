class UserStocksController < ApplicationController
  ...
  def create
    # Create a new UserStock only if we have stock_id parameter
    ...
    respond_to do |format|
      if @user_stock.save
        ...
        format.json { render :show, status: :created, location: my_portfolio_path }
      else
  ...
  def destroy
    @user_stock.destroy
    respond_to do |format|
      format.html { redirect_to my_portfolio_path, notice: 'Stock was successfully removed form portfolio.' }
